...
const HomePage = () => {
    ...
    let [visibleTagsLimit, setVisibleTagsLimit] = useState(10);
    ...
    const fetchTags = () => {
        axios.get(import.meta.env.VITE_SERVER_DOMAIN + "/get-tags")
            .then(({ data }) => {
                setTags(data.tags);
            })
            .catch(err => {
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div>
                                    ...
                                    tags == null ? (
                                        ...
                                        tags.slice(0, visibleTagsLimit).map((tag, i) => (
                                            <button
                                                ...
                                                className={"tag " + (pageState === tag.toLowerCase() ? " bg-black text-white " : "")}
                                                key={i}
                                            >
                                                {tag}
                                            </button>
                            ...
                            {tags && tags.length > visibleTagsLimit && (
                                <button
                                    onClick={() => setVisibleTagsLimit(prev => prev + 2)}

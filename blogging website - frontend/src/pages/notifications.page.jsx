...
const Notifications = () => {
    ...
    return (
        <div className="pt-0 max-md:pt-0">
            ...
            <div className="my-8 max-md:mt-2 max-md:mb-8 flex gap-6">
                {
            ...
            </div>
            {
                notifications == null ? <Loader /> :
                    <>
                        ...
                        <LoadMoreDataBtn state={notifications} fetchDataFun={fetchNotifications} additionalParam={notifications.deletedDocCount}/>

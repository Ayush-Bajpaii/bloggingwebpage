        ...
        <>
            ...
            <div className="flex gap-6 justify-between">
                <div className="flex gap-3 items-center">
                    <button 
                    onClick={handleLike}
                    className={"w-10 h-10 rounded-full items-center flex justify-center " + (islikedByUser ? "bg-red/20 text-red" : "bg-grey/80" )}
                    
                    >
                        <i className={"fi " + (islikedByUser ? 
                            "fi-sr-heart" : "fi-rr-heart"
                        )}></i>
                    </button>
                    ...
                    className="w-10 h-10 rounded-full items-center flex justify-center bg-grey/80">
                        <i className="fi fi-sr-message-quote"></i>
                    </button>

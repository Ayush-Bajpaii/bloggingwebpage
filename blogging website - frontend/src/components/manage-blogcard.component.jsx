...
export const BlogStats = ({ stats }) => {
    return(
        <div className="flex gap-3 max-lg:mb-6 max-lg:pb-6 max-lg:border-b max-lg:border-grey">
            {
...
export const ManagePublishedBlogCard = ({ blog }) => {
    ...
    let {  title,banner,blog_id , publishedAt,activity} = blog;

    let [ showStat, setShowStat ] = useState(false);
    console.log(showStat)
     return (
        <>
        <div className="flex gap-10 mb-6 max-md:px-4 border-grey pb-6 items-center border-b">
        ...
        <div className="flex flex-col justify-between py-2 w-full min-w-[300px]">
            ...
            <div className="gap-6 mt-3 flex">
                ...
                >Stats</button>
                <button className="pr-2 py-2 underline text-red"
    ...
    return (
        <div className="flex gap-5 lg:gap-10 pb-6 border-b mb-6 border-grey">
            ...
            <div>
                ...
                <p className="line-clamp-2 fontgelasio ">{des.length ? des : "No description"}</p>

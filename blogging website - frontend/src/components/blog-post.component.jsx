...
const BlogPostCard = ({content, author}) => {
    ...
    let { publishedAt, title, des, banner, tags, activity :{ total_likes = 0 } = {}, blog_id: id } = content;
    ...
    return (
        ...
        <div className="w-full">
            <div className="flex gap-2 items-center mb-7">
                ...
                <p className="ine-clamp-1">{fullname} @{username}</p>
        ...
        <div className="h-28 aspect-square bg-grey rounded-2xl">
            <img src={banner} className="w-full h-full aspect-square object-cover rounded-2xl"/>
        </div>
        </Link>
